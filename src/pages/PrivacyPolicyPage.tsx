...
export default function PrivacyPolicyPage() {
  useEffect(() => {
    ...
    applyMeta(buildStaticMeta(
      'Privacy Policy',
      'Read the Mayobe Bros Privacy Policy to understand how we collect, use, and protect your personal information.',
      '/privacy-policy',
    ));
  }, []);
      ...
      <div className="container mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="ml-0 sm:ml-16 space-y-3">
              ...
              <div className="bg-gray-50 dark:bg-gray-900 p-4 sm:p-6 rounded-lg mt-4">
                <div className="space-y-3 text-gray-700 dark:text-gray-300 text-sm sm:text-base">
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white mb-1">General &amp; Newsletter Inquiries</p>
                    <a href="mailto:info@mayobebros.com" className="text-blue-600 dark:text-blue-400 hover:underline">info@mayobebros.com</a>
                  </div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white mb-1">Technical Support &amp; Account Help</p>
                    <a href="mailto:support@mayobebros.com" className="text-blue-600 dark:text-blue-400 hover:underline">support@mayobebros.com</a>
                  </div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white mb-1">Executive / CEO Contact</p>
                    <a href="mailto:mclean@mayobebros.com" className="text-blue-600 dark:text-blue-400 hover:underline">mclean@mayobebros.com</a>
                  </div>
                  <div className="border-t border-gray-200 dark:border-gray-700 pt-3">
                    <p><strong>Website:</strong> www.mayobebros.com</p>
                    <p className="mt-1"><strong>Response Time:</strong> We aim to respond to all inquiries within 48 hours</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between border-t border-gray-200 dark:border-gray-700 pt-6 mt-8">
            ...
            <SocialShare title="Privacy Policy — Mayobe Bros" description="Read Mayobe Bros privacy policy to understand how we collect, use, and protect your personal information." />
          </div>
        </div>
      </div>
    </div>
